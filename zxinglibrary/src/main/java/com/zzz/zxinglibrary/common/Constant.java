package com.zzz.zxinglibrary.common;
...
public class Constant {
    ...
    public static final String CAMERA_SCAN_ACTION = "cameraScanAction";
    public static final String CAMERA_SCAN_RESULT = "cameraResult";
    public static final String WARN_SCAN_ACTION = "warnScanAction";
    public static final String WARN_SCAN_RESULT = "warnMsg";
